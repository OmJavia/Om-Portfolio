        ...
        <section id="footer" className="min-h-screen">
          <nav className="p-10 flex justify-between rounded-md">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a className="font-bolder bg-gradient-to-r from-blue-700 to-blue-500 text-white font-bolder px-4 py-2 rounded-md ml-8 font-semibold shadow-md dar:shadow-slate-400" 
